...
def run_sft(
    ...
    data_collator = SFTDataCollatorWith4DAttentionMask(
        ...
        # align FP8 kernels (torchao _scaled_mm)
        pad_to_multiple_of=16 if training_args.do_train else None,
    ...
    if is_transformers_version_greater_than("4.58.0"):
        ...
        all_eos_ids = [tokenizer.eos_token_id] + \
            [i for i in extra_ids if i != -1]
